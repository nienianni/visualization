<!--<template>
    ...
    <div id="daka" style="height: 400px;width: 600px">
    ...
    export default {
        ...
        methods: {
            drawLine: function(){
                ...
                let chartmainline = this.$echarts.init(document.getElementById("daka"));
...
<template>
    <div class="checkdep">
        <div id="checkdep" style="width:100%; height:520px;"></div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted: function() {
            this.checkdep = this.$echarts.init(document.getElementById('checkdep'), 'wonderland');
